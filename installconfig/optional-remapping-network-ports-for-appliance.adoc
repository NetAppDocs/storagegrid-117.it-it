...
Non è possibile utilizzare le porte rimappate per gli endpoint del bilanciamento del carico. Se è necessario rimuovere una porta rimappata, seguire la procedura descritta in link:../maintain/removing-port-remaps.html["Rimuovere i rimap delle porte"].
