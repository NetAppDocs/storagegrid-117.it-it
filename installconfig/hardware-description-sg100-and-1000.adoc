...
IMPORTANT: Se si utilizzano nodi Admin e nodi Gateway nello stesso gruppo ha, la porta solo nodo Admin non eseguirà il failover. Consultare le istruzioni per link:../admin/configure-high-availability-group.html["Configurazione dei gruppi ha"].
