...
---
= Verificare il componente da sostituire in SGF6112
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Utilizzare questa procedura per identificare l'appliance con hardware guasto e quali dei seguenti componenti hardware sostituibili non funzionano correttamente:
...
+
image::../media/nodes_page_hardware_tab_appliance_verify_nic.png[Sezione appliance per i componenti hardware]
...
+
link:turning-sgf6112-identify-led-on-and-off.html["Accendere e spegnere il LED di identificazione dell'apparecchio"]
