...
summary: 'Quando si pianifica un aggiornamento a StorageGRID 11.7, è necessario prendere in considerazione quando eseguire l"aggiornamento, in base alla durata dell"aggiornamento. È inoltre necessario conoscere le operazioni che è possibile eseguire e non è possibile eseguire durante ciascuna fase dell"aggiornamento.' 
---
...
[role="lead"]
Quando si pianifica un aggiornamento a StorageGRID 11.7, è necessario prendere in considerazione quando eseguire l'aggiornamento, in base alla durata dell'aggiornamento. Devi anche essere consapevole delle operazioni che puoi eseguire e che non puoi eseguire durante ogni fase dell'aggiornamento.
...
10 secondi per nodo o pochi minuti per l'intera griglia
 a| 
L'aggiornamento da StorageGRID 11.6 a 11.7 non richiede un aggiornamento del database Cassandra; tuttavia, il servizio Cassandra verrà arrestato e riavviato su ciascun nodo di storage.
...
== Esempio: Tempo stimato per l'aggiornamento a StorageGRID 11.7
...
. Sommare i valori.
+
L'aggiornamento del sistema a StorageGRID 11.7 deve durare fino a 17 ore.
