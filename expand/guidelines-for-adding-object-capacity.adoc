...
* Per aggiungere uno o due shelf di espansione a un'appliance di storage SG6060, visitare il sito Web all'indirizzo link:../sg6000/adding-expansion-shelf-to-deployed-sg6060.html["Aggiunta di shelf di espansione a SG6060 implementato"].
* Per un nodo basato su software, seguire le istruzioni perlink:adding-storage-volumes-to-storage-nodes.html["Aggiunta di volumi di storage ai nodi di storage"].
