...
NOTE: Questo elenco non include le porte che potrebbero essere configurate come link:../admin/configuring-load-balancer-endpoints.html["endpoint del bilanciamento del carico"] o utilizzato per link:../monitor/configuring-syslog-server.html["server syslog"].
