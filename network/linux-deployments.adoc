...
Consultare le istruzioni di installazione per link:../rhel/index.html["Red Hat Enterprise Linux o CentOS"] oppure link:../ubuntu/index.html["Ubuntu o Debian"] implementazioni.
...
* link:../rhel/configuring-host-network.html["Configurare la rete host (Red Hat Enterprise Linux o CentOS)"]
