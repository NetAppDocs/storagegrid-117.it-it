...
summary: 'L"avviso S3 PUT object size too large viene attivato se un tenant tenta un"operazione PUT object non multiparte che supera il limite di dimensione S3 di 5 GiB.' 
---
...
.. Invio `cd /var/local/audit/export`
