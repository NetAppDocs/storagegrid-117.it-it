...
NOTE: Se si eseguono processi di ripristino dei volumi, link:../maintain/restoring-volume.html["Monitorare l'avanzamento e visualizzare una cronologia di tali lavori in Grid Manager"] invece.
