...
. Passare a. link:selecting-start-recovery-to-configure-appliance-storage-node.html["Selezionare Start Recovery (Avvia ripristino) per configurare il nodo di storage dell'appliance"].
