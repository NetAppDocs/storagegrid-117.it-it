...
. Quando il nodo di storage raggiunge la fase "`Waiting for Manual Steps`", passare a. link:remounting-and-reformatting-storage-volumes-manual-steps.html["Rimontare e riformattare i volumi di storage (procedura manuale)"].
+
