...
144102530435]]
----
Il valore dell'attributo ATYP è SPUT. link:sput-s3-put.html["SPUT"] Rappresenta una transazione S3 PUT, che registra l'acquisizione di un oggetto in un bucket.
