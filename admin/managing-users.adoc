...
Grid Manager include un utente locale predefinito, denominato "`root`". Impossibile rimuovere l'utente root.
...
+
Se un utente appartiene a più gruppi, le autorizzazioni sono cumulative. Vederelink:managing-admin-groups.html["Gestire i gruppi di amministratori"] per ulteriori informazioni.
